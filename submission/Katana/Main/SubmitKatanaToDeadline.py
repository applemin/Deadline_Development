...
def SubmitPressed( gui ):
    ...
    if not submitScene and CheckIsPathLocal(scene):
        selection = QMessageBox.question( gui, "Local Katana Scene Submission", "The Katana scene is local and is not being submitted with the job. Deadline Slaves may not be able to find the Katana file. Do you wish to submit anyway?", QMessageBox.Yes, QMessageBox.No )
