...
def __main__():
    ...
    metaScriptDialog.SetIcon( RepositoryUtils.GetRepositoryFilePath( "plugins/Quicktime/Quicktime.ico", True ) )
    ...
    if outputFilenameCount > 0:        
        ...
        if versionId != "":
            ...
            shotgunSettingsPath = Path.Combine( ClientUtils.GetUsersSettingsDirectory(), "QuicktimeSettingsShotgun.ini" )
