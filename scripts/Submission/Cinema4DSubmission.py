...
def __main__():
    ...
    versionBox = scriptDialog.AddComboControlToGrid("VersionBox","ComboControl","19",("12","13","14","15","16","17","18","19","20"), 4, 1 )
    ...
    scriptDialog.AddSelectionControlToGrid("SubmitSceneBox","CheckBoxControl",False,"Submit Cinema 4D Scene", 5, 2, "If this option is enabled, the scene file will be submitted with the job, and then copied locally to the slave machine during rendering.", colSpan=2)
