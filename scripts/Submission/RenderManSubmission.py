...
def ParseRibFiles( filename ):
    ...
    try:
        ...
        # Valid frame number
        if paddingSize > 0:
            startFrame = GetLowerFrameFolderRange( filename, initFrame, paddingSize )
            endFrame = GetUpperFrameFolderRange( filename, initFrame, paddingSize )
