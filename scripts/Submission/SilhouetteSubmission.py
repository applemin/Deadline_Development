...
def GetSettingsFilename():
    return Path.Combine( ClientUtils.GetUsersSettingsDirectory(), "SilhouetteSettings.ini" )
...
def SubmitButtonPressed( *args ):
    ...
    jobInfoFilename = Path.Combine( ClientUtils.GetDeadlineTempPath(), "silhouette_job_info.job" )
    ...
    pluginInfoFilename = Path.Combine( ClientUtils.GetDeadlineTempPath(), "silhouette_plugin_info.job" )
