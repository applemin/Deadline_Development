...
SCENE_FILE_PATH ='A:/RenderShot_Dir/Files/eavzSKZJ3RAubAq/CoffeeMillAnimationV3xr62939/Coffee Mill Animation V3xr.bip'
NEW_SCENE_FILE_NAME = os.path.basename(SCENE_FILE_PATH)
NEW_TEMP_SCENE_FILE_NAME ='A:/RenderShot_Dir/Files/eavzSKZJ3RAubAq/CoffeeMillAnimationV3xr62939/Coffee Mill Animation V3xr__3.bip'
...
# NEW_SCENE_FILE_NAME = os.path.basename(SCENE_FILE_PATH)
# NEW_TEMP_SCENE_FILE_NAME ='made_to_travel_black_rev4_1561016265_Camera 2_2_.bip'
# def valid_temp_folder():
#     if os.path.exists(HOME_PATH):
#         print('Temp folder has already been created.')
#         return True
