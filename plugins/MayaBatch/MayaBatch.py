...
class MayaBatchPlugin (DeadlinePlugin):
    ...
    def StartJob( self ):
        ...
        if SystemUtils.IsRunningOnMac():
            ...
            if Directory.Exists( mayaPythonVersionFolder ):
                self.SetEnvironmentAndLogInfo( "PYTHONHOME", mayaPythonVersionFolder )
                ...
                if self.FirstTask:
                    ...
                    if self.XGenPathMapping:
                        ...
                        if len( mappings ) > 0:
                            ...
                            scriptBuilder.AppendLine( 'catch( mapXGen( $deadlineMappings ) );' )
                            scriptBuilder.AppendLine()
    ...
    def CreateDelayLoadSceneMelscript( self, scriptBuilder ):
        ...
        scriptBuilder.AppendLine( 'catch( python( "DeadlineMayaBatchFunctions.ForceLoadPlugins()" ) );' )
